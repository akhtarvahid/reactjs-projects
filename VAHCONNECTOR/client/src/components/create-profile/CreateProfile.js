             ...
             <div className="container">
              <div className="row">
               <div className="col-md-8 m-auto">
                <h2 className="dispaly-4 text-center">Create your Profile</h2>
                 ...
                 <form onSubmit={this.onSubmit}>
                  <TextFieldGroup 
                   ...
                   info="City or city & state suggested (eg. Banglore)" 
                   />
                   <TextFieldGroup 
                   placeholder="Skills"
                   name="skills"
                   ...
                   onChange={this.onChange}
                   error={errors.skills}
                   info="Please use comma seperated values(eg. HTML, CSS, JavaScript, Nodejs)" 
                   />
                   <TextFieldGroup 
